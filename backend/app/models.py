...
class Order(Base):
    ...
    subtotal_mad = Column(Numeric(10, 2), nullable=False, default=0)
    discount_mad = Column(Numeric(10, 2), nullable=False, default=0)
    total_mad = Column(Numeric(10, 2), nullable=False)
...
class OrderItem(Base):
    ...
    price_mad = Column(Numeric(10, 2), nullable=False)
    created_at = Column(DateTime(timezone=True), nullable=False, default=utcnow)
