...
class Order(Base):
    ...
    subtotal_mad = Column("subtotal_sar", Numeric(10, 2), nullable=False, default=0)
    discount_mad = Column("discount_sar", Numeric(10, 2), nullable=False, default=0)
    total_mad = Column("total_sar", Numeric(10, 2), nullable=False)
    ...
    ttclid = Column(String(2048), nullable=True)
    sc_click_id = Column(String(512), nullable=True)
...
class OrderItem(Base):
    ...
    price_mad = Column("price_sar", Numeric(10, 2), nullable=False)
    created_at = Column(DateTime(timezone=True), nullable=False, default=utcnow)
