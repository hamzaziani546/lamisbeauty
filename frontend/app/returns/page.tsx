...
export const metadata: Metadata = {
  ...
  description: "سياسة الاستبدال والإرجاع في لاميس للجمال.",
};
  ...
  return (
    <div dir="rtl" className="bg-[#FFF8F1] min-h-screen py-16">
      <div className="container-padded max-w-3xl">
        <h1 className="text-3xl font-bold text-[#251F20] mb-2">
        ...
        <div className="bg-white rounded-3xl p-8 border border-[#E8DAD6] shadow-sm space-y-6">
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">ضماننا</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">
          ...
          <section>
            ...
            <p className="text-[#6F6262] text-sm leading-relaxed mb-4">
              تواصلي معنا عبر صفحة التواصل مع ذكر رقم طلبك وصورة المنتج إن كان
              هناك تلف. سنرد في أقرب وقت ممكن.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-[#8F3F55] text-white font-bold px-6 py-3 rounded-full hover:bg-[#7a3549] transition-colors text-sm"
            >
              تواصلي معنا
            </Link>
          </section>
