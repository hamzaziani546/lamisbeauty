...
export const metadata: Metadata = {
  ...
  description: "سياسة الخصوصية لموقع لاميس للجمال.",
};
  ...
  return (
    <div dir="rtl" className="bg-[#FFF8F1] min-h-screen py-16">
      <div className="container-padded max-w-3xl">
        <h1 className="text-3xl font-bold text-[#251F20] mb-2">سياسة الخصوصية</h1>
        ...
        <div className="bg-white rounded-3xl p-8 border border-[#E8DAD6] shadow-sm space-y-6">
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">ما المعلومات التي نجمعها؟</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">البكسلات الإعلانية وCAPI</h2>
            <p className="text-[#6F6262] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">كيف نستخدم معلوماتك؟</h2>
            <ul className="text-[#6F6262] text-sm leading-relaxed space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">مشاركة البيانات</h2>
            <p className="text-[#6F6262] text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#251F20] mb-3">حقوقك</h2>
            <p className="text-[#6F6262] text-sm leading-relaxed">
